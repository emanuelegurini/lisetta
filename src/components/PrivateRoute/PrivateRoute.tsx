          ...
          <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
            ...
            <div className={cn("grid gap-6")}>
              <Auth
                ...
                providers={[]} // Rimuovi i provider OAuth se non li vuoi
                view="sign_in" // Puoi cambiare in "sign_up" se vuoi
                showLinks={true} // Mostra i link per passare tra sign in/sign up
                localization={{
                  variables: {
                    sign_in: {
                      email_label: "Email",
